...
while running:
    ...
    #campo
    pygame.draw.rect(screen, "white", (state.field_coords[0],
                                               state.field_coords[1],
                                               state.field_coords[2]- state.field_coords[0],
                                               state.field_coords[3] - state.field_coords[1]), 4)
    ...
    for player in state.players.values():
        ...
        name_text = font1.render(str(name), True, pygame.Color("white"))
    ...
    if red_baliza_post:
        baliza_rect = baliza.get_rect(center=(int(red_baliza_post.x-83), int(red_baliza_post.y + 150)))
        screen.blit(baliza, baliza_rect)
    if blue_baliza_post:
        # rodar baliza para a equipa azul
        baliza_rect = baliza2.get_rect(center=(int(blue_baliza_post.x+83), int(blue_baliza_post.y + 150)))
    ...
    if state.match_manager.state == MatchState.PLAYING:
        ...
        screen.blit(font2.render("Break", True, pygame.Color("white")), (960, 540))
